...
export interface Kind6Table<T1, T2, T3, T4, T5, T6> {
}
...
export type Kind6Keys = keyof Kind6Table<any, any, any, any, any, any>;

export type AllKindKeys = Kind1Keys | Kind2Keys | Kind3Keys | Kind4Keys | Kind5Keys | Kind6Keys
...
export type Kind5 = Kind5Keys | Apply<Kind6, any>
export type Kind6 = Kind6Keys

export type AllKinds = Kind1 | Kind2 | Kind3 | Kind4 | Kind5 | Kind6
...
export type Apply<F extends AllKinds, T> =
    ...
    F extends [infer F1 extends Kind6Keys, infer T1, infer T2, infer T3, infer T4, infer T5] ? Kind6Table<T1, T2, T3, T4, T5, T>[F1] :
